...
public class SysIdResultsPublisher {
  ...
  public static synchronized void publish(
      String testName, boolean interrupted, SysIdRunStats stats) {
    String entry =
        String.format(
            ...
            stats.getDurationSec(),
            stats.getMaxAbsAppliedVolts(),
            stats.getStartPosition(),
            stats.getEndPosition(),
            stats.getDeltaPosition(),
            stats.getStartVelocity(),
            stats.getEndVelocity(),
            stats.getPeakAbsVelocity());
