...
/** Collects summary stats for a single SysId run without publishing live telemetry. */
public class SysIdRunStats {
  ...
  public SysIdRunStats(
      DoubleSupplier positionSupplier, DoubleSupplier velocitySupplier, double[] appliedVoltsRef) {
