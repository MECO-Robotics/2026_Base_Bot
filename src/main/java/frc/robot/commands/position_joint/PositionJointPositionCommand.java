...
public class PositionJointPositionCommand extends Command {
  ...
  /**
   * Creates a position setpoint command for a position joint with a temporary max-velocity limit.
   *
   * @param positionJoint target subsystem
   * @param position supplier for desired position
   * @param maxVelocity supplier for temporary max profile velocity
   */
  ...
  /**
   * Creates a position setpoint command for a position joint with optional compliance mode after
   * reaching target.
   */
  public PositionJointPositionCommand(
